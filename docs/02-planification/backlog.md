...
DS-010 est implémentée pour CHIRPS v3 quotidien : téléchargement idempotent, découpage BBOX, nettoyage des valeurs invalides, SHA-256 et manifeste JSON. DS-011 est partiellement couverte par les contrôles de valeurs négatives, non finies et nodata ; l’agrégation quotidienne et le contrôle de couverture sont maintenant disponibles, mais le rapport géographique multi-années reste à produire.
