...
|---|---|---|---|---|---|---|
| DS-011A | 2026-09-17 | Agent du projet | Pilote multi-zone, validateur | Manifeste court valide et rapport qualité | En cours autorisé | Relancer une période courte avec contrôle de durée et archiver le résultat |
| DS-011B | Après DS-011A | Agent du projet | DS-011A, stockage stable | Couverture multi-années par zone | Bloqué | Ne pas démarrer avant un manifeste court valide |
