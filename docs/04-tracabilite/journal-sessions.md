...
## Session 2026-09-17 — Vérification de l’archive Drive DS-011C

Le premier archiveur unitaire a échoué à cause d’un chemin absolu refusé par `gws`, puis une seconde tentative a rencontré une erreur interne de l’API Drive. La stratégie a été corrigée : les 1 825 rasters nettoyés sont regroupés dans `fara-vokatra-1991-cleaned.zip`, tandis que le manifeste, le rapport qualité et le fichier de checksums sont transférés séparément. La présence des quatre artefacts a été vérifiée dans `Fara-Vokatra/1991` sur Drive. Le checksum SHA-256 de l’archive est `dd57779a50b8989c12bbbc90a15ba6edefce527b601263e5dd2540b4dea5b180`.
